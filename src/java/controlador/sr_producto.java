...
public class sr_producto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            producto = new Producto(Integer.valueOf(request.getParameter("txt_existencia")),Integer.valueOf(request.getParameter("txt_marca")),request.getParameter("txt_producto"),request.getParameter("txt_Descripcion"),Integer.valueOf(request.getParameter("txt_preciocosto")),Integer.valueOf(request.getParameter("txt_precioventa")));
